...
return {
  ...
  config = function()
    require('nvim-tree').setup({
      ...
      notify = {
        threshold = vim.log.levels.WARN, -- only show WARN and ERROR (hides INFO messages like rename/copy)
        absolute_path = true,            -- optional: keep file paths absolute in messages
      },
    })
  end,
}
